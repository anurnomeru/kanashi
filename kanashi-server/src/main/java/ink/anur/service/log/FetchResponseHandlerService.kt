...
class FetchResponseHandlerService : AbstractRequestMapping() {
    ...
    @NigateInject
    private lateinit var fetchHandleService: FetchHandleService
    ...
    override fun handleRequest(fromServer: String, msg: ByteBuffer, channel: Channel) {
        ...
        fetchHandleService.fetchMutex {
            ...
            if (!electionMetaService.isLeader()) {
                 ...
                 */
                if (commandContainer.fileLogItemSetSize == 0)  return@fetchMutex
                byteBufPreLogService.append(commandContainer.generation, commandContainer.read())
            } else {

                val fetchTo = fetchHandleService.fetchTo!!
